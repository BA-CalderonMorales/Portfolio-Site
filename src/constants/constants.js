export const projects = [
  ...
  },
  {
    ...
    source:
      "https://github.com/BA-CalderonMorales/YoutubeCloneProject-Frontend",
  ...
  },
  {
    ...
    description:
      `I built this web application using an api called ChatEngine IO. I was able to integrate this chat engine within my ` +
  ...
  },
  {
    title: "Music Library",
    description:
      `In this project, I worked with another buddy of mine, Carter Wiley, in creating a music library that stores a user's favorite ` +
    ...
    source:
      "https://github.com/BA-CalderonMorales/MusicLibraryProject-FrontEnd",
    visit: "https://www.linkedin.com/in/bcalderonmorales-cmoe/",
    id: 3,
  },
];
...
export const TimeLineData = [
  {
    year: 2015,
    text: "Needed to find a way to pay for my education, so I enlisted in the Marines.",
  },
  {
    year: 2016,
    text: "Attended a court reporting course in the Marines with a high dropout rate. Passed with flying colors.",
  },
  {
    year: 2018,
    text: "Travelled to Spain with a Marine Corps SPMAGTF-CR-AF 19.1 to serve as their Legal Chief",
  },
  {
    year: 2019,
    text: "Honorably discharged from the USMC at the rank of Sergeant. Started college again.",
  },
  {
    year: 2021,
    text: "Graduated DevCodeCamp in August of this year. Founded CodingHelp101 Discord Server.",
  },
  {
    year: 2022,
    text: "Currently employed at Leidos. Trying to finish college soon. Only 10 credits left!",
  },
];
